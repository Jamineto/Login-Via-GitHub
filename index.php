...
<html lang="en">
  ...
  <?php
    ...
    echo
      ...
      <div class="row">
        <a href="https://github.com/login/oauth/authorize?client_id=d1eef707a6568ef48440" class="btn btn-dark btn-lg" role="button"><i class="fab fa-github"></i> | Login via GitHub</a>
      </div>
      ';
